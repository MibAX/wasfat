...
import { CategoryAdminService, CategoryDto, CrudCategoryDto } from '@proxy/categories';
...
export class CategoryDialogComponent implements OnInit {
  ...
  save(): void {
    ...
    const category: CrudCategoryDto = this.mapFormToCategory()
    if (this.isEditMode) {
  ...
  private mapFormToCategory(): CrudCategoryDto {
