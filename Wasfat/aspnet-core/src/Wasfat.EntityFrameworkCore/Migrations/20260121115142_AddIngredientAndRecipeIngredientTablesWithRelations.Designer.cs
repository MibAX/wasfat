...
namespace Wasfat.Migrations
{
    ...
    [Migration("20260121115142_AddIngredientAndRecipeIngredientTablesWithRelations")]
    partial class AddIngredientAndRecipeIngredientTablesWithRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryRecipe", b =>
                {
                    ...
                    b.ToTable("AppRecipeCategories", (string)null);
                });
            ...
            modelBuilder.Entity("Wasfat.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wasfat.Ingredients.Ingredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wasfat.Instructions.Instruction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppInstructions", (string)null);
                });

            modelBuilder.Entity("Wasfat.RecipeIngredients.RecipeIngredient", b =>
                {
                    b.Property<int>("RecipeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CategoryRecipe", b =>
                {
                    b.HasOne("Wasfat.Categories.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wasfat.Recipes.Recipe", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wasfat.Instructions.Instruction", b =>
                {
                    b.HasOne("Wasfat.Recipes.Recipe", "Recipe")
            ...
            modelBuilder.Entity("Wasfat.RecipeIngredients.RecipeIngredient", b =>
                {
                    b.HasOne("Wasfat.Ingredients.Ingredient", "Ingredient")
